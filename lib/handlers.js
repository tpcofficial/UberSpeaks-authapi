...
handlers.index = function(data, callback) {
    if (data.method == 'get') {
        try {
            callback(200, fs.readFileSync("site/index.html"), 'text/HTML');
        } catch (e) {
            try {
...
/*handlers.web.userCreate = function() {

};

handlers.web.userDelete = function() {

};

handlers.web.userUpdate = function() {
